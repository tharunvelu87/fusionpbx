	...
	//theme settings
		if (is_array($_SESSION['theme']) && @sizeof($_SESSION['theme']) != 0) {
			...
			//pre-process some settings
				...
				$settings_array['theme']['footer'] = isset($settings_array['theme']['footer']) ? $settings_array['theme']['footer'] : "<span style='color: #000;'>&copy; ".$text['theme-label-copyright']." 2008 - ".date('Y')." <a href='http://www.geniuspbx.com' style='color: #000; font-weight: bold;' target='_blank'>geniuspbx.com</a> ".$text['theme-label-all_rights_reserved']."</span>";
