...
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_uuid'] = '60c93c27-4ff4-46ab-b041-6670b25222ef';
$array['dashboard'][$x]['dashboard_groups'][$y]['group_name'] = 'superadmin';
$y++;
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_group_uuid'] = '6f94c763-a37e-442c-93ce-e722133e2bbf';
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_uuid'] = '60c93c27-4ff4-46ab-b041-6670b25222ef';
$array['dashboard'][$x]['dashboard_groups'][$y]['group_name'] = 'admin';
$y++;
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_group_uuid'] = '11584924-0155-42ca-8040-19b8d4ea59e8';
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_uuid'] = '60c93c27-4ff4-46ab-b041-6670b25222ef';
